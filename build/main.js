...
class AirApi {
    ...
    async setPriceForDates({
        ...
        try {
            ...
            _log2.default.e("Airbnbapi: Couldn't set price for cal day for listing " + listing_id);
            _log2.default.e(e);
        }
    }
    //////////// LISTING SECTION ////////////
    ...
    async setListingAvailability({ token, listing_id, availability }) {
        ...
        try {
            ...
            _log2.default.e("Airbnbapi: Couldn't set listing availability for listing " + listing_id);
            _log2.default.e(e);
        }
    }
    ...
    async declineReservation({ token, reservation_id, message = '' } = {}) {
        if (!(token || this.config.token)) {
            _log2.default.e("Airbnbapi: Can't decline reservation without a token");
            return null;
        } else if (!reservation_id) {
            _log2.default.e("Airbnbapi: Can't decline reservation without a reservation_id");
            return null;
        }
        const options = this.buildOptions({
            method: 'PUT',
        ...
        try {
            ...
            _log2.default.e("Airbnbapi: Couldn't decline reservation " + reservation_id);
            _log2.default.e(e);
        }
    }
